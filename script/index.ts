...
export module NeverStopWatch
{
    ...
    {
        specification: "https://github.com/wraith13/never-stop-watch/README.md";
        title: string;
        timeAccuracy: number;
        pass: string;
        todos: string[];
    ...
    export module OldStorage
    {
        ...
        {
            const specification = "https://github.com/wraith13/never-stop-watch/README.md";
        ...
        export const importJson = (json: string) =>
        {
            try
            {
                ...
                if
                (
                    "https://github.com/wraith13/never-stop-watch/README.md" === data.specification &&
        ...
        export module TagSettings
        {
            ...
            export const get = (pass: string, tag: string) =>
                getStorage(pass).getOrNull<NeverStopWatch.TagSettings>(makeKey(pass, tag)) ?? { };
            export const set = (pass: string, tag: string, settings: NeverStopWatch.TagSettings) =>
    ...
    export module Storage
    {
        ...
        export module ToDoList
        {
            ...
            export const get = (pass: string) => minamo.localStorage.getOrNull<NeverStopWatch.Content>(makeKey(pass));
            export const set = (pass: string, list: NeverStopWatch.Content) => minamo.localStorage.set(makeKey(pass), list);
            export const remove = (pass: string) =>
            {
    ...
    export module SessionStorage
    {
        ...
        {
            export const makeKey = (pass: string) => `document:(${pass})`;
            export const get = (pass: string) => minamo.sessionStorage.getOrNull<NeverStopWatch.Content>(makeKey(pass));
            export const set = (pass: string, list: NeverStopWatch.Content) => minamo.sessionStorage.set(makeKey(pass), list);
            export const remove = (pass: string) =>
            {
    ...
    export module Model
    {
        ...
        export class Tag
        {
            ...
            setSettings = (settings: NeverStopWatch.TagSettings) => this.document.tagSettings.set(this, settings);
        ...
        export class Document
        {
            ...
            tagSettings =
            {
                ...
                set: async (tag: Tag, settings: NeverStopWatch.TagSettings) =>
    ...
    export module Render
    {
        ...
        export const showListHomeScreen = async (pass: string, urlParams: PageParams) =>
        {
            const tag = "@overall";
            let entry = { tag, pass, todo: OldStorage.TagMember.get(pass, tag) };
            let list = entry.todo.map(task => Domain.getToDoEntryOld(entry.pass, task));
        ...
        [
            ...
            (
                "GitHub",
                async () => location.href = "https://github.com/wraith13/never-stop-watch/",
            ),
        ];
        ...
        else
        {
            ...
            default:
                if (0 <= OldStorage.Pass.get().indexOf(pass))
                {
                    ...
                    "@overall" === (tag ?? "@overall") ?
                        Render.showListHomeScreen(pass, urlParams):
